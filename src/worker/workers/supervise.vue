<template>
  <div class="supervise">
    ...
    <div>
      <ul class="ulstyle">
        <li class="listyle" @click="click(1)">
        ...
        <li class="listyle" @click="click(2)">
        ...
        <li class="listyle" @click="click(3)">
        ...
        <li class="listyle" @click="click(4)">
        ...
        <li class="listyle" @click="click(5)">
          <img src="../../assets/u41.png">
          <div class="msgstyle">
            <p>待付款</p>
        ...
        <li class="listyle" @click="click(6)">
          <img src="../../assets/u43.png">
          <div class="msgstyle">
            <p>取消/终止</p>
